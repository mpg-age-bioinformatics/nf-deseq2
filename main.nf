  ...
  script:
    ...
    if [[ "${params.run_type}" == "studio" ]] || [[ "${params.run_type}" == "raven" ]] ; 
      ...
      then
        ...
        if [[ ! -f rnaseq.python-3.8-8.sif ]] ;
          then
            singularity pull rnaseq.python-3.8-8.sif docker://index.docker.io/mpgagebioinformatics/rnaseq.python:3.8-8
        fi
    ...
    if [[ "${params.run_type}" == "local" ]] ; 
      ...
      then
        ...
        docker pull mpgagebioinformatics/rnaseq.python:3.8-8
